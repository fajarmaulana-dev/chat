...
<template>
    <div class="bg-slate-100 min-h-screen sm:px-mobile md:px-desktop 2xl:px-0 sm:pt-4 md:pt-6">
        <div class="flex gap-4 lg:gap-6 relative overflow-hidden max-w-screen-xl mx-auto">
            <div
                ...
                <div :class="{ 'fixed md:relative': !id }"
                    ...
                    <Input ref="searchrooms" with-prefix type="text" wrapper-class="min-h-10"
                        placeholder="Cari pesan ..." @prefix="input => input.focus()" @input="handleFilterRooms">
                    <template #prefix>
                    ...
                    <div ref="chats" :style="{ backgroundImage: `url(${getImage('bg.webp')})` }"
                        ...
                        <div v-for="chat in currentChat.data" :key="chat.id" class="flex"
                            ...
                            <div class="p-3 w-4/5 rounded-2xl"
                                ...
                                <img v-if="chat.chat.startsWith('[file]')" :src="chat.chat.split(' ')[1]"
                                    alt="chat-pict" class="w-full h-auto">
                                ...
                                <div v-if="chat.product" class="flex flex-col gap-0.5 w-full overflow-hidden mt-2.5">
                                    ...
                                    <span class=" text-xs font-medium text-sky-600">
                                        Rp{{ chat.product.price.toLocaleString('id-ID') }}</span>
                                </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button v-for="product, idx in PRODUCTS" :key="idx" aria-label="product"
                                    ...
                                    <b class="text-slate-800 font-semibold block truncate text-left">{{ product.name
                                        }}</b>
                                    <span class="text-sky-600 text-xs font-medium block text-left">
